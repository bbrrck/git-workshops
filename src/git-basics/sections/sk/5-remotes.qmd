...
::: {data-id=create-repo .shutter style="background-image: url('./git-basics/img/gh-new-repo/gh-new-full.png')"}
:::

## Vytvorenie repozitára na Githube --- [github.com/new](https://github.com/new)  {auto-animate=true}
::: {data-id=create-repo .shutter style="background-image: url('./git-basics/img/gh-new-repo/gh-new-full.png'); margin-top: -500px;"}
:::
...
::: {data-id=create-repo .shutter style="background-image: url('./git-basics/img/gh-new-repo/gh-new-full.png'); margin-top: -1550px;"}
:::
...
::: {.screenshot}
![](./git-basics/img/gh-new-repo/gh-new-full.png)
:::


## Vytvorenie repozitára na Githube --- [github.com/new](https://github.com/new)
::: {.screenshot}
![](./git-basics/img/gh-new-repo/gh-new-top.png)
:::


## Vytvorenie repozitára na Githube --- [github.com/new](https://github.com/new)
::: {.screenshot}
![](./git-basics/img/gh-new-repo/gh-new-bottom.png)
:::

<!-- SHUTTER: EMPTY REPO -->

<!-- ## {auto-animate=true transition="fade" transition-speed="fast"}
::: {data-id=shNewEmptyRepo .shutter style="margin-top: 0px; background-image: url('./git-basics/img/gh-new-repo/gh-new-empty-repo.png')"}
:::


## {auto-animate=true}
::: {data-id=shNewEmptyRepo .shutter style="margin-top: -400px; background-image: url('./git-basics/img/gh-new-repo/gh-new-empty-repo.png')"}
:::
...
## Vytvorenie repozitára na Githube --- [github.com/new](https://github.com/new)
::: {.screenshot}
![](./git-basics/img/gh-new-repo/gh-new-empty-repo.png)
:::


## Vytvorenie repozitára na Githube --- [github.com/new](https://github.com/new)
::: {.screenshot}
![](./git-basics/img/gh-new-repo/gh-new-empty-repo-circled.png)
:::
...
::: {.columns}
::: {.column width=30%}
![](./git-basics/img/gh-win-auth/credential-helper-selector-v2.png){.gh-win-auth}
:::
::: {.column width=25%}
![](./git-basics/img/gh-win-auth/auth-signin.png){.gh-win-auth}
:::
::: {.column width=20%}
![](./git-basics/img/gh-win-auth/auth-confirm.png){.gh-win-auth}
:::
::: {.column width=25%}
![](./git-basics/img/gh-win-auth/auth-success.png){.gh-win-auth style="height:200px"}
:::
:::
...
::: {.fontsize-090 }
1. Vytvor si na [Azure DevOps](https://dev.azure.com/tiborstanko/git-workshop-2023-04-19/_settings/repositories) repo s názvom `zoo-meno-priezvisko`, napr. `zoo-tibor-stanko`
