...
![](./git-basics/img/how-not-to-name-files.png)

## Prečo potrebujeme systémy riadenia verzií?
![](./git-basics/img/how-not-to-name-files-crossed.png)
...
## {background-image="./git-basics/img/github-screenshot.png" background-size="contain"}
