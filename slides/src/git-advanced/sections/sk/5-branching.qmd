...
- feature vetvy sa niekedy nepoužívajú vôbec - vývojári commitujú priamo do hlavnej vetvy
...
2. **Frekvencia integrácie riadi kvalitu** - časté zlučovanie snižuje zložitosť, riziko a strach z integrácie; umožňuje refaktoring a zlepšuje zdravie kódu

3. **Moderná osvedčená prax uprednostňuje trunk-based development** - elitné tímy integrujú často s CI/CD; voľba workflowu závisí od kontextu (trunk-based pre aplikácie s jednou verziou, Gitflow pre viacero produkčných verzií)
